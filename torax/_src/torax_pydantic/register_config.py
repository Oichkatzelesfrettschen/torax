...
def _validate_source_model_config(
    ...
    match source_name:
        ...
        case cyclotron_radiation_heat_sink_lib.CyclotronRadiationHeatSink.SOURCE_NAME:
            default_model_name = (
        ...
        case generic_ion_el_heat_source_lib.GenericIonElectronHeatSource.SOURCE_NAME:
            default_model_name = (
