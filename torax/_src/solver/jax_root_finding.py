...
def _body(
    ...
    output_state = {
        ...
        "iterations": jnp.array(input_state["iterations"][...], dtype=dtype)
        + 1,
    ...
    if log_iterations:
        jax.debug.print(
            ...
            iteration=output_state["iterations"].astype(
                jax_utils.get_int_dtype()
            ),
...
def _delta_body(
    ...
    return input_delta_state | dict(
        ...
        tau=jnp.array(
            input_delta_state["tau"][...], dtype=jax_utils.get_dtype()
        )
